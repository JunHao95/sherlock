...
@Gooey(program_name='CSI Spy Program on Emails')
def main():
   ...
   #                         )
    parser = GooeyParser(formatter_class=RawDescriptionHelpFormatter,description="My Cool Gooey App!")

    parser.add_argument("--version",
                        action="version", version=version_string,widget="CheckBox",
                        help="Display version information and dependencies."
                        )
    parser.add_argument("--verbose", "-v", "-d", "--debug",
                        action="store_true", dest="verbose", default=False,widget="CheckBox",
                        help="Display extra debugging information and metrics."
                        )
    parser.add_argument("--folderoutput", "-fo", dest="folderoutput",widget="FileSaver",
    ...
    parser.add_argument("--tor", "-t",
                        action="store_true", dest="tor", default=False,widget="CheckBox",
                        help="Make requests over Tor; increases runtime; requires Tor to be installed and in system path.")
    parser.add_argument("--unique-tor", "-u",
                        action="store_true", dest="unique_tor", default=False,widget="CheckBox",
                        help="Make requests over Tor with new Tor circuit after each request; increases runtime; requires Tor to be installed and in system path.")
    parser.add_argument("--csv",
                        action="store_true", dest="csv", default="",widget="FileSaver",
                        help="Create Comma-Separated Values (CSV) File."
                        )
    parser.add_argument("--site",
                        action="append", metavar="SITE_NAME",
                        dest="site_list", default=None,widget="FileChooser",
                        help="Limit analysis to just the listed sites. Add multiple options to specify more than one site."
                        )
    parser.add_argument("--proxy", "-p", metavar="PROXY_URL",
                        action="store", dest="proxy", default=None,nargs="+",widget="Textarea",
                        help="Make requests over a proxy. e.g. socks5://127.0.0.1:1080"
                        )
    parser.add_argument("--json", "-j", metavar="JSON_FILE",
                        dest="json_file", default=None,widget="FileChooser",
    ...
    parser.add_argument("--print-all",
                        dest="print_all", action="store_true", default=False,widget="CheckBox",
                        help="Output sites where the username was not found."
                        )
    parser.add_argument("--print-found",
                        action="store_false", dest="print_found", default=False,widget="CheckBox",
                        help="Output sites where the username was found."
                        )
    parser.add_argument("--no-color",
                        action="store_true", dest="no_color", default=False,widget="CheckBox",
   ...
   #                     )
    parser.add_argument('--usernames',nargs="+",
                        metavar='Input Email Address',action="store",
    ...
    parser.add_argument("--browse", "-b",
                        widget = "Textarea",action="store", dest="browse", default="",
                        help="Browse to all results on default browser.")

    parser.add_argument("--local", "-l",
                        action="store_true", default=False,widget="CheckBox",
    ...
    #Gooey Parsing?
   # G_parser = GooeyParser(description="Extracting Platforms that a particular Email has created an account")
   # ffmpeg = G_parser.add_argument_group('Platform Extraction Information')
